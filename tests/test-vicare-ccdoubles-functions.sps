...
#!vicare
(import (vicare)
  (vicare math ccdoubles functions)
...
(parametrise ((check-test-name	'version))
  ...
  (check
      (fixnum? (ccdoubles_version_interface_current))
    => #t)

  (check
      (fixnum? (ccdoubles_version_interface_revision))
    => #t)

  (check
      (fixnum? (ccdoubles_version_interface_age))
    => #t)

  (check
      (string? (cstring->string (ccdoubles_version_string)))
    => #t)
